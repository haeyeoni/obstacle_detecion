...
if(obstacle_detection_CONFIG_INCLUDED)
  return()
endif()
set(obstacle_detection_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(obstacle_detection_SOURCE_PREFIX /home/haeyeon/3dvision_project/obstacle_detection)
  set(obstacle_detection_DEVEL_PREFIX /home/haeyeon/3dvision_project/obstacle_detection/build/devel)
  set(obstacle_detection_INSTALL_PREFIX "")
  set(obstacle_detection_PREFIX ${obstacle_detection_DEVEL_PREFIX})
else()
  set(obstacle_detection_SOURCE_PREFIX "")
  set(obstacle_detection_DEVEL_PREFIX "")
  set(obstacle_detection_INSTALL_PREFIX /usr/local)
  set(obstacle_detection_PREFIX ${obstacle_detection_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'obstacle_detection' is deprecated")
...
set(obstacle_detection_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/usr/include/eigen3;/usr/include/pcl-1.8;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(obstacle_detection_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include/eigen3;/usr/include/pcl-1.8;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'haeyeon <haeyeon8669@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${obstacle_detection_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'obstacle_detection' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'obstacle_detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/haeyeon/3dvision_project/obstacle_detection/${idir}'.  ${_report}")
    endif()
    _list_append_unique(obstacle_detection_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND obstacle_detection_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND obstacle_detection_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT obstacle_detection_NUM_DUMMY_TARGETS)
      set(obstacle_detection_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::obstacle_detection::wrapped-linker-option${obstacle_detection_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR obstacle_detection_NUM_DUMMY_TARGETS "${obstacle_detection_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::obstacle_detection::wrapped-linker-option${obstacle_detection_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND obstacle_detection_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/haeyeon/3dvision_project/obstacle_detection/build/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(obstacle_detection_LIBRARY_DIRS ${lib_path})
      list(APPEND obstacle_detection_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'obstacle_detection'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND obstacle_detection_LIBRARIES ${lib})
    endif()
  endif()
...
set(obstacle_detection_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${obstacle_detection_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "geometry_msgs;roscpp;std_msgs;sensor_msgs;tf;pcl_conversions")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 obstacle_detection_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${obstacle_detection_dep}_FOUND)
      find_package(${obstacle_detection_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${obstacle_detection_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(obstacle_detection_INCLUDE_DIRS ${${obstacle_detection_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(obstacle_detection_LIBRARIES ${obstacle_detection_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${obstacle_detection_dep}_LIBRARIES})
  _list_append_deduplicate(obstacle_detection_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(obstacle_detection_LIBRARIES ${obstacle_detection_LIBRARIES})

  _list_append_unique(obstacle_detection_LIBRARY_DIRS ${${obstacle_detection_dep}_LIBRARY_DIRS})
  list(APPEND obstacle_detection_EXPORTED_TARGETS ${${obstacle_detection_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${obstacle_detection_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
